...
const threads: readonly Thread[] = [
  {
    ...
    posts: [
      ...
      },
      {
        ...
        votes: 3,
        body: "GENERAL is for questions and ideas. ERRATA is for mistakes and what they taught you, from here or your own practice. Project boards keep the work in context; tags help people find it.",
      },
    ],
  },
  {
