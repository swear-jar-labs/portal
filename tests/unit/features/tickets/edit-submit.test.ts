...
import { submitTicketEdit } from "@/features/tickets/edit-submit";
import { freshTicketAccess } from "@/features/tickets/mock-ticket-access";
...
vi.mock("@/features/tickets/mock-ticket-access", () => ({
